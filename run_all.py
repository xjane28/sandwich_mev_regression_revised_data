...
import sys
import time
from src import m0_validate, m1_prepare, m2_concentration, m3_bot_dynamics, m4_victims, m5_timeseries, m6_synthesis, m7_reports, m8_hypothesis_tests
...
def run_pipeline():
    ...
    try:
        ...
        print("\n--- [Step 3b] H1 Hypothesis Tests & Scale/Activity Synthesis ---")
        m8_hypothesis_tests.run_h1_tests()
